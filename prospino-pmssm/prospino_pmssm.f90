...
!  inlo = 0  ! Cant calculate NLO for individual squarks anyway
!  do isquark1_in=-4,4,1                   ! not sure if we should include sbottoms here
!     if ( isquark1_in==0 ) cycle
!     do isquark2_in=-4,4,1                ! not sure if we  should include sbottoms here
!        if ( isquark2_in==0 ) cycle
!        call PROSPINO(inlo,isq_ng_in,icoll_in,energy_in,i_error_in,final_state_in,ipart1_in,ipart2_in,isquark1_in,isquark2_in) ! actual prospino call
!     enddo
!  enddo
  ...
  call PROSPINO(inlo,isq_ng_in,icoll_in,energy_in,i_error_in,final_state_in,ipart1_in,ipart2_in,isquark1_in,isquark2_in) ! actual prospino call
!  inlo = 0  ! Cant calculate NLO for individual squarks anyway
!  do isquark1_in=-4,4,1
!     if ( isquark1_in==0 ) cycle
!     do isquark2_in=-4,4,1
!     if ( isquark2_in==0 ) cycle
!        call PROSPINO(inlo,isq_ng_in,icoll_in,energy_in,i_error_in,final_state_in,ipart1_in,ipart2_in,isquark1_in,isquark2_in) ! actual prospino call
!     enddo
!  enddo
...
!  enddo
  ...
  ipart1_in = 2                                                             !
  call PROSPINO(inlo,isq_ng_in,icoll_in,energy_in,i_error_in,final_state_in,ipart1_in,ipart2_in,isquark1_in,isquark2_in) ! actual prospino call
!  for now we turn off NLO calculation for slepton production
  inlo=0
  final_state_in = 'll'                                                     !
  do ipart1_in=0,14,1
     call PROSPINO(inlo,isq_ng_in,icoll_in,energy_in,i_error_in,final_state_in,ipart1_in,ipart2_in,isquark1_in,isquark2_in) ! actual prospino call
  ...
  do ipart1_in=1,8,1
     call PROSPINO(inlo,isq_ng_in,icoll_in,energy_in,i_error_in,final_state_in,ipart1_in,ipart2_in,isquark1_in,isquark2_in) ! actual prospino call
  enddo
!  (disabled) option to turn off NLO calculation for EW production
!  inlo=0

  final_state_in = 'nn'                                                     !
  do ipart1_in=1,4,1
     do ipart2_in=ipart1_in,8,1
        call PROSPINO(inlo,isq_ng_in,icoll_in,energy_in,i_error_in,final_state_in,ipart1_in,ipart2_in,isquark1_in,isquark2_in) ! actual prospino call
     enddo
  enddo
  do ipart1_in=5,6,1
